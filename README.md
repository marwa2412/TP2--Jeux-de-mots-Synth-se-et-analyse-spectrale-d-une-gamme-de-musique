...
## Introduction
  ...
  La synthèse spectrale peut être utilisée pour créer des instruments virtuels ou pour moduler des sons enregistrés. L'analyse spectrale est l'inverse de la synthèse
  spectrale. Il s'agit d'une technique utilisée pour décomposer un son en ses différentes fréquences. Cela permet de comprendre comment un son est créé et de découvrir
 ...
 - Partie 2 : Synthèse et analyse spectrale d’une gamme de musique
   ...
   2.2: Spectre de la gamme de musique
      ...
      3. Traçage du spectrogramme
        ...
        • Un spectrogramme est un type de graphique utilisé pour visualiser la répartition de l'énergie d'un signal dans le temps et dans le domaine fréquentiel. Il
        est généralement utilisé pour étudier les signaux audio et les signaux de communication. Il est produit en utilisant une technique d'analyse appelée analyse
   ...
   2.3:  Approximation du spectre d’un signal sinusoïdal à temps continu par FFT
      ...
      4. Spectre de fréquence de la gamme musicale crée en échelle linéaire, puis avec une échelle en décibels.
         ...
         des niveaux de puissance ou de son qui varient sur des plages très grandes. L'échelle en décibels est un logarithme de l'échelle linéaire, ce qui permet de
         représenter des valeurs de manière plus compacte.
## Conclusions
